...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("spring.websocket", "org.springframework:spring-websocket:6.1.5")
            library("spring.messaging", "org.springframework:spring-messaging:6.1.5")
